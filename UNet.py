...
class Unet(nn.Module):
    def __init__(self, in_ch, out_ch):
        ...
        self.up6 = nn.ConvTranspose2d(32, 32, 1, stride=1)
        self.conv6 = DoubleConv(64, 32)
        self.up7 = nn.ConvTranspose2d(32, 32, 1, stride=1)
        self.conv7 = DoubleConv(64, 32)
        self.up8 = nn.ConvTranspose2d(32, 32, 1, stride=1)
        self.conv8 = DoubleConv(64, 32)
        self.up9 = nn.ConvTranspose2d(32, 32, 1, stride=1)
